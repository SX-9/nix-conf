{ ... }: {
  ...
  dconf.settings = {
    ...
    "org/gnome/shell" = {
      ...
      favorite-apps = ["org.gnome.Nautilus.desktop" "org.gnome.TextEditor.desktop" "org.gnome.SystemMonitor.desktop" "org.gnome.Console.desktop" "google-chrome.desktop" "discord.desktop" "code.desktop"];
    };
